...
import 'package:flutterdemoproject/model/travel_model.dart';
...
///AutomaticKeepAliveClientMixin 保持当前页面不被回收，也占用内存大
          ...
          child: MediaQuery.removePadding(
            ...
            child: StaggeredGridView.countBuilder(
              ...
              staggeredTileBuilder: (int index) =>
                  new StaggeredTile.fit(2), //一个item占几列
            ),
          ),
        ),
      ),
              ...
              children: <Widget>[
                ...
                LimitedBox(
                  ...
                  child: Text(
                    _poiName(),
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis, //省略号显示的方式
